...
router.post("/options", (0, express_validator_1.body)("categoryId").optional({ nullable: true }).isNumeric(), function (req, res, next) { return (0, category_controllers_1.options)(req, res, next); });
