...
router.get("/get-categories", function (req, res) {
    return (0, products_controllers_1.getCategories)(req, res);
});
...
router.post("/fetch-products", (0, express_validator_1.body)("pageIndex").notEmpty().isNumeric(), (0, express_validator_1.body)("pageSize").notEmpty().isNumeric(), function (req, res) { return (0, products_controllers_1.fetchProducts)(req, res); });
